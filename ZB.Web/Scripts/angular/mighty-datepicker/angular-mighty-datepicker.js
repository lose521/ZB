(function() {
  ...
  <div class=\"mighty-picker__month\"\
    ...
    <div class=\"mighty-picker__month-name\" ng-bind=\"getChineseMonthName(month.name)\"></div>\
    <table class=\"mighty-picker-calendar\">\
      <tr class=\"mighty-picker-calendar__days\">\
        <th ng-repeat=\"day in ::month.weeks[1]\"\
          ...
          {{:: getChineseWeekName(day.date.day()) }}\
        </th>\
      </tr>\
    ...
    >>\
      ...
      return {
        ...
        link: function($scope, $element, $attrs) {
          ...
          $scope.getChineseMonthName = function (monthName) {
              var items = monthName.split(' ');
              var monthNames = "January_February_March_April_May_June_July_August_September_October_November_December".split("_");
              var chineseMonthNames = "一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_");
              for (var i = 0; i < monthNames.length; i++) {
                  if (monthNames[i] == items[0])
                      return items[1] + '年' + chineseMonthNames[i];
              }
              return '';
          };
          $scope.getChineseWeekName = function (weekday) {
              var chineseWeekNames = "日_一_二_三_四_五_六".split("_");
              return chineseWeekNames[weekday];
          };
